...
const testimonials = [
  {
    ...
    review:
      "I’m happy to share that I’ve obtained a certification: Certificate of Participation in Code-O-lympics of D3 - Techno Management Fest from IIT Bhubaneswar",
    image: m1, // Points to imported image
  },
  {
    name: "Cisco Networking Academy",
    role: "NIIT Foundation",
    review:
      "Certified – Introduction to Cybersecurity | Cisco Networking Academy (May 2025)Developed a foundational understanding of cyber threats (Malware, Phishing, DDoS) and mitigation strategies.",
    image: w1,
  },
  {
    name: "Cloud Computing and Amazone Web Service",
    role: "Academy Of Skill Devlopment",
    review:
      " Successfully completed Cloud Computing with AWS (Project-Based) from Academy of Skill Development with an A++ Grade!, Gained practical skills in deploying and managing cloud solutions.",
    image: m2,
  },
  {
    ...
    role: "Delloite",
    review:
      "I just completed Deloitte Data Analytics.In the simulation i Completed a Deloitte job simulation involving data analysis and forensic technology Created a data dashboard using Tableau,Used Excel to classify data and draw business conclusions",
    image: w2,
  },
];
        ...
        {testimonials.map((testi, idx) => (
          ...
          >
            ...
            <img
              ...
              className="w-150 h-120rectangle-full border-2 border-white/40 mb-4 object-cover"
