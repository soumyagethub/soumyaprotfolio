        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
              I focus on building clean, functional, and creative tech—from polished web applications to experimental projects. Driven by a constant desire to explore and create, I blend solid engineering with a curious mindset to bring unique digital ideas to life.
            </p>
            ...
            <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 max-w-xl">
              {[
                ...
                { label: "Specialty", value: "Web Development" },
        ...
        <div className="grid md:grid-cols-1">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
             Student developer and fitness freak with a passion for building innovative, high-performance applications and continuously improving myself—both in tech and in life.
            </p>
