...
const socials = [
 // { Icon: FaYoutube, label: "YouTube", href: "https://www.youtube.com/@gauravbitss" },
  { Icon: FaXTwitter, label: "X", href: "https://x.com/Soumyar85565467" },
  { Icon: FaLinkedinIn, label: "LinkedIn", href: "https://www.linkedin.com/in/soumya-ranjan-mohanty-726451287?utm_source=share_via&utm_content=profile&utm_medium=member_ios" },
  { Icon: FaInstagram, label: "Instagram", href: "https://www.instagram.com/soumyafits_11?igsh=bXFvcWQweGo3d2Rs&utm_source=qr" },
  { Icon: FaGithub, label: "GitHub", href: "https://github.com/soumyagethub" },
];


const glowVariants = {
  initial: { scale: 1, y: 0, filter: "drop-shadow(0 0 0 rgba(93, 41, 225, 0))" },
  hover: {
    scale: 1.2,
    y: -3,
    filter:
      "drop-shadow(0 0 8px rgba(74, 133, 222, 0.9)) drop-shadow(0 0 18px rgba(210, 35, 76, 0.8))",
...
const Home = React.forwardRef((props, ref) => {
  const roles = useMemo(
    () => ["AI & ML", "Web Developer", "Data Analytics", "Fitness freak"],
    []
  );
    ...
    >
      ...
      <div className="absolute inset-0">
        <div
          ...
          rounded-full
          bg-gradient-to-r from-[#302b63] via-[#00bf8f] to-[#1dD8D2]
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        ...
        >
          <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
            ...
            >
              <span>
  {/* Yeh aapka existing typing logic hai */}
  {roles[index].substring(0, subIndex)}
</span>

{/* ISKO YAHAN PASTE KAREIN 
<motion.span
  animate={{ opacity: [0, 1, 0] }}
  transition={{ repeat: Infinity, duration: 0.8 }}
  className="inline-block w-[2px] h-[1em] ml-1 bg-white"
/>*/}
              <span
            ...
            >
              B.Tech Computer Science student at KIIT,
              passionate about building clean, scalable, and 
              high-performance web applications while constantly
               exploring creative and experimental tech 👨🏻‍💻☕️ 📈.
            </motion.p>
